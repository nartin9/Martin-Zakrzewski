...
public class Weapon : MonoBehaviour
{
    ...
    public void ShotgunFire(Ray ray)
    {
        Vector3[] shots = new Vector3[8];
        ...
        for (int i = 0; i < 0; i++)
        {
            ...
            {
                //hit.collider.gameObject.GetComponent(HasHealth) -= Weapon.damage;
                    HitEffects(hit);
    ...
    public RaycastHit Fire(Ray ray)
    {
