...
public class WeaponHandler : MonoBehaviour
{
	...
	public void FireCurrentWeapon (Ray aimRay)
    {
        ...
        HHealth health;
        health = currentWeapon.Fire(aimRay).collider.GetComponent<HHealth>();  
        int damage1 = currentWeapon.damage;
        if(currentWeapon.Fire(aimRay).collider.GetComponent<HHealth>() != null)
